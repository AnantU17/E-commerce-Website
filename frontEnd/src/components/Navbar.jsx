    ...
    return (
        <div className="flex items-center justify-between  font-medium">
            ...
            <div className="flex items-center gap-6">
                <img onClick={()=>setShowSearch(true)} src={assets.search_icon} className="w-10 cursor-pointer" />
                <div className="group relative">
                    <img onClick={()=>token ? null : navigate('/login')} src={assets.profile} className="w-6 cursor-pointer" alt="" />
                    {/* -------------Dropdown menu------- */}
                    {token &&
            ...
            <div className={`absolute top-0 bottom-0 overflow-hidden bg-white transition-all ${visible ? 'w-full' : 'w-0'}`}>
                ...
                <div onClick={()=>setVisible(false)} className="flex items-center cursor-pointer gap-4 p-3">
                    <img src={assets.dropdown} className="h-4 rotate-90" alt="" />
                    <p>Back</p>
                </div>
